...
IM1 = snapshot(cam);                                                    %get snapshot from the webcam video and store to IM1 variable
figure(1);subplot(3,3,1);imshow(IM1);title('Background');                 %open up a figure and show the image stored in IM1 variable

pause(5);                                                                 %pause a second before taking the test image snapshot
IM2 = snapshot(cam);                                                    %get snapshot of test image and store to variable IM2
